...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-10">
            <a href="<?php echo e(route('categoria.create')); ?>" class="btn btn-primary">NUEVO</a>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('categoria.show', $item->id)); ?>" class="btn btn-success">PRODUCTOS</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\donas\resources\views/admin/categoria/index.blade.php ENDPATH**/ ?>