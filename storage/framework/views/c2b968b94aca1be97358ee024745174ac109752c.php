...
<div class="container bg-success pb-5">
    <div class="row">
        ...
        <div class="col-sm-8 bg-white p-5">
            ...
            <ul>
                <li>Razón Social: <?php echo e($config->razonsocial); ?></li>
                <li>Dirección: <?php echo e($config->direccion); ?></li>
                <li>Celular: <?php echo e($config->celular); ?></li>
                <li>Email: <?php echo e($config->email); ?></li>
            </ul>
...
<?php echo $__env->make('layouts.appfront', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\donas\resources\views/front/contacto.blade.php ENDPATH**/ ?>