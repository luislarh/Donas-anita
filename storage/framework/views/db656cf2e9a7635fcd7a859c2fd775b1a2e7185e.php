    ...
    <div class="row">
        ...
        <div class="jumbotron">
            ...
            <div class="form-group">
                ...
                <?php echo Form::text('description', $producto->description ,['class'=>'form-control', 'maxlength' =>'155']); ?>
            ...
            <div class="form-group">
                ...
                <img src="/img/producto/<?php echo e($producto->urlfoto); ?>" >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\donas\resources\views/admin/producto/edit.blade.php ENDPATH**/ ?>