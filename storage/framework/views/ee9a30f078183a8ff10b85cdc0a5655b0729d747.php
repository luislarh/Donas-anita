    ...
    <div class="row">
        ...
        <div class="jumbotron">
            ...
            <div class="form-group">
                ...
                <?php echo Form::textarea('description', null ,['class'=>'form-control', 'maxlength' =>'155']); ?>

            </div>
            <div class="form-group">
                <label for="nombre">Ingrese Nombre</label>
                <?php echo Form::text('nombre', null ,['class'=>'form-control', 'maxlength' =>'155']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\donas\resources\views/admin/post/create.blade.php ENDPATH**/ ?>